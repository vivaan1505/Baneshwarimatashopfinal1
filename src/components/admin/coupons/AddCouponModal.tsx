...
const AddCouponModal: React.FC<AddCouponModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  useEffect(() => {
    ...
    if (selectedBrandId) {
      ...
      if (selectedBrand && selectedBrand.website) {
      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        ...
        <div className="relative bg-white rounded-lg w-full max-w-2xl">
          <div className="flex justify-between items-center p-6 border-b">
            <h2 className="text-xl font-medium">Add New Coupon</h2>
