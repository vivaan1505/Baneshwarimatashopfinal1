            ...
            <div className="mb-6">
              ...
              <div className="bg-blue-50 p-4 rounded-md dark:bg-blue-900/20">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-400">
                  ...
                  <code className="bg-blue-100 px-2 py-1 rounded dark:bg-blue-800/50">https://example.com/image1.jpg|https://example.com/image2.jpg</code>
                </p>
              </div>
            </div>
                ...
                {validationSuccess && (
                  <div className="bg-green-50 p-4 rounded-md mb-4 dark:bg-green-900/20">
                    <div className="flex">
                      ...
                      <h4 className="text-sm font-medium text-green-800 dark:text-green-400">File validation successful</h4>
                    </div>
                  </div>
                )}
