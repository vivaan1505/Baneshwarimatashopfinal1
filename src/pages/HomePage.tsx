    ...
    default:
      return (
        <div className="bg-gradient-to-br from-primary-50 via-blue-50 to-fuchsia-50 dark:from-gray-900 dark:via-gray-950 dark:to-black">
          ...
          {/* Newsletter Section */}
          <section className="py-24 bg-gradient-to-br from-fuchsia-700 via-blue-600 to-primary-800 text-white">
            <div className="container-custom">
              <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-4xl font-heading font-extrabold mb-4">Join Our Community</h2>
                ...
                <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                  <input
                    ...
                    className="flex-grow px-4 py-3 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-accent-500"
                    required
                  />
                  <button
                    type="submit"
                    className="bg-white text-fuchsia-700 hover:bg-gray-100 px-7 py-3 rounded-lg font-bold transition"
                  >
                    Subscribe
                  </button>
                </form>
