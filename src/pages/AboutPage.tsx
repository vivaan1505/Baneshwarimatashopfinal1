      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="bg-primary-50 p-8 rounded-xl">
            <h2 className="text-2xl font-heading font-medium mb-4">Our Mission</h2>
          ...
          <div className="bg-secondary-50 p-8 rounded-xl">
            <h2 className="text-2xl font-heading font-medium mb-4">Our Vision</h2>
            <p className="text-gray-700 leading-relaxed">
        ...
        <div className="mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl font-heading font-medium mb-6">Our Story</h2>
              <div className="space-y-4 text-gray-600">
                <p>
                  Founded in 2020, LuxeTrends emerged from a vision to transform the luxury shopping experience for the digital age. What began as a carefully curated collection of designer footwear has evolved into a comprehensive luxury lifestyle destination.
                </p>
                <p>
                ...
                <p>
                  Today, LuxeTrends serves customers across the globe, offering not just products, but a gateway to luxury lifestyle. Our expert stylists, detailed product curation, and commitment to customer satisfaction have earned us recognition as a leader in luxury e-commerce.
                </p>
              </div>
            </motion.div>
        ...
        {/* Values Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-heading font-medium mb-8 text-center">Our Values</h2>
        ...
        {/* Team Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-heading font-medium mb-8 text-center">Leadership Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Chief Creative Officer</p>
            </div>
        ...
        {/* CTA Section */}
        <div className="bg-primary-900 text-white rounded-xl p-12 text-center">
