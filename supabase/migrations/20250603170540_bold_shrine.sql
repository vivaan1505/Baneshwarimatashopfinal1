/*
  # Create chatbot tables and scripts

  1. New Tables
    - `chatbot_scripts` - Stores predefined responses for the chatbot
    - `chatbot_settings` - Stores configuration for the chatbot

  2. Initial Data
    - Default welcome and fallback messages
    - Comprehensive set of chatbot scripts for different categories
*/
...
('Product Customization', 'Products', 
  ...
  'Select products offer customization options such as monogramming or engraving. If customization is available, you will see the option on the product page. Please note that customized items cannot be returned unless they arrive damaged or defective.',
  true);
...
('Order Status', 'Orders', 
  ...
  'You can check your order status by logging into your account and visiting the "Orders" section. Once your order ships, you will receive a confirmation email with tracking information. If you have specific questions about your order, please contact our customer service team with your order number.',
  true);
...
('Order Processing Time', 'Orders', 
  ...
  'Most orders are processed within 1-2 business days. During peak seasons or promotional periods, processing may take up to 3 business days. Once your order ships, you will receive a confirmation email with tracking information.',
  true);
  
INSERT INTO chatbot_scripts (name, section, trigger_keywords, response, is_active) VALUES
('Order Confirmation', 'Orders', 
  ARRAY['order confirmation', 'confirm order', 'confirmation email', 'order receipt', 'order email'],
  'After placing an order, you should receive an order confirmation email within minutes. If you do not see it, please check your spam folder. You can also view your order confirmation by logging into your account and visiting the "Orders" section.',
  true);
...
('Shipping Delays', 'Shipping', 
  ...
  'Occasionally, shipping delays may occur due to weather conditions, customs processing, or carrier issues. If your tracking information has not updated in 48 hours or your package is significantly delayed, please contact our customer service team with your order number for assistance.',
  true);
