...
('Shipping Options', 'Shipping', 
  ...
  E'We offer several shipping options: Standard (5-7 business days), Express (2-3 business days), and Overnight (next business day if ordered before 2 PM ET). Shipping options and rates are displayed during checkout and vary based on your location and order value.',
  true);
  
INSERT INTO chatbot_scripts (name, section, trigger_keywords, response, is_active) VALUES
('Shipping Costs', 'Shipping', 
  ARRAY['shipping cost', 'shipping fee', 'delivery cost', 'shipping charges', 'how much is shipping', 'free shipping'],
  E'Shipping costs depend on your location, selected shipping method, and order value. We offer free standard shipping on orders over $75. Exact shipping costs will be calculated and displayed during checkout before you complete your purchase.',
  true);
...
('International Shipping', 'Shipping', 
  ...
  E'Yes, we ship to most countries worldwide. International shipping typically takes 7-14 business days. Please note that international orders may be subject to import duties and taxes, which are the responsibility of the recipient. These charges are not included in our shipping fees.',
  true);
...
('Shipping Restrictions', 'Shipping', 
  ...
  E'We ship to most countries, but there are some restrictions due to international regulations. Currently, we cannot ship to North Korea, Iran, Cuba, Syria, and Sudan. Additionally, certain products may have specific shipping restrictions. These will be noted on the product page.',
  true);
  
INSERT INTO chatbot_scripts (name, section, trigger_keywords, response, is_active) VALUES
('Shipping Delays', 'Shipping', 
  ARRAY['shipping delay', 'delayed shipment', 'late delivery', 'package delayed', 'shipping problems'],
  E'Occasionally, shipping delays may occur due to weather conditions, customs processing, or carrier issues. If your tracking information hasn''t updated in 48 hours or your package is significantly delayed, please contact our customer service team with your order number for assistance.',
  true);
