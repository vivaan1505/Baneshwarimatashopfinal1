/*
  ...
  1. New Tables
    - Ensures `site_branding` table exists with proper columns
  2. Security
    - Enables RLS on the table
    - Adds policies for viewing, inserting, updating, and deleting site branding assets
...
BEGIN
  IF NOT EXISTS (
    ...
    ADD CONSTRAINT site_branding_type_check 
